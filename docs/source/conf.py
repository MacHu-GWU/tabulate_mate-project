# -*- coding: utf-8 -*-
#
# tabulate_mate documentation build configuration file, created by
...
version = tabulate_mate.__version__
# The full version, including alpha/beta/rc tags.
release = tabulate_mate.__version__
...
html_logo = "./_static/tabulate_mate-logo.png"
html_favicon = "./_static/tabulate_mate-favicon.ico"
...
htmlhelp_basename = 'tabulate_matedoc'
...
latex_documents = [
    (master_doc, 'tabulate_mate.tex', 'tabulate_mate Documentation',
     u'Sanhe Hu', 'manual'),
]
...
man_pages = [
    (master_doc, 'tabulate_mate', 'tabulate_mate Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'tabulate_mate', 'tabulate_mate Documentation',
     author, 'tabulate_mate', 'One line description of project.',
     'Miscellaneous'),
]
...
# Add data for Jinja2
try:
    from tabulate_mate.docs import doc_data
except:
    doc_data = dict()
...
package_name = tabulate_mate.__name__
